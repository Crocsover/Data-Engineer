...
data set from link : [data sources]([https://github.com](https://github.com/imjbmkz/JDLS000-Developing-ETL-pipelines-using-SQL-Server-Integration-Services-SSIS/tree/main/data_sources))
